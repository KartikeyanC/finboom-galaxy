  ...
  return (
    <div className="space-y-2">
      <Label className="flex items-center gap-1.5">
        ...
        {label}
        <span className="text-[10px] text-muted-foreground font-normal">· auto-filled</span>
      </Label>
            ...
            <div className="flex flex-wrap gap-1 pt-1">
              {[
                ...
                <button
                  ...
                  type="button"
                  onClick={q.action}
                  className="rounded-full border border-border/50 px-2 py-0.5 text-[10px] text-muted-foreground hover:bg-accent/40 hover:text-foreground"
                >
                  {q.label}
                </button>
              ))}
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <button
          ...
          className="rounded-full border border-dashed border-border/60 px-2.5 py-1 text-[11px] font-medium text-muted-foreground hover:text-foreground hover:bg-accent/40"
        >
          Specific date
        </button>
      </div>
